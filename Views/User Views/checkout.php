    ...
    <div class="row">
        ...
        <div class="col">
            <form name="form" action="" method="POST">
                ...
                <div class="form-group">
                    <label for="inputCardDetails">Card Details</label>
                    <input type="text" maxlength="10" required class="form-control" name="inputCardDetails" id="inputCardDetails" placeholder="Enter Card Details">
                </div>
                <div class="">
                    <!--<a type="submit" class="btn btn-success" href="thankyou.php?id=<?=$watch_received[0]['ID']?>">Order</a>-->
