            ...
            <div class="col">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="Date" class="form-control" id="inputDateOfBirth" placeholder="Enter Date of Birth">
                    </div>
                    <div class="form-group">
                        <label for="inputCardDetails">Card Details</label>
                        <input type="text" class="form-control" id="inputCardDetails" placeholder="Enter Card Details">
                    </div>
